...
app.get(['/api/meters/discover', '/api/meters'], (_req: Request, res: Response) => {
...
app.get('/api/meters-all/latest', (_req: Request, res: Response) => {
...
app.get('/api/plant/summary', (_req: Request, res: Response) => {
...
app.get(['/api/simulation/status', '/api/simulation/state'], (_req: Request, res: Response) => {
...
app.post(['/api/simulation/clear-faults', '/api/simulation/clear'], (_req: Request, res: Response) => {
